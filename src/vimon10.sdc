...
create_generated_clock -name clock_sclk -source [get_ports {CLK25M}] -master_clock clock_25MHz -multiply_by 10 -duty_cycle 50 -phase 45 [get_pins {lcd_sclk_pll/rpll_inst/CLKOUTP}]
create_generated_clock -name clock_250MHz -source [get_ports {CLK25M}] -master_clock clock_25MHz -multiply_by 10 -duty_cycle 50 [get_pins {lcd_sclk_pll/rpll_inst/CLKOUT}]
