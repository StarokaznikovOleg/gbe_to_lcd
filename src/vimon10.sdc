...
create_clock -name clock_25MHz -period 40 -waveform {0 20} [get_ports {CLK_25M}]
create_generated_clock -name clock_sclk -source [get_ports {CLK_25M}] -master_clock clock_25MHz -multiply_by 10 -duty_cycle 50 -phase 45 [get_pins {lcd_sclk_pll/rpll_inst/CLKOUTP}]
create_generated_clock -name clock_250MHz -source [get_ports {CLK_25M}] -master_clock clock_25MHz -multiply_by 10 -duty_cycle 50 [get_pins {lcd_sclk_pll/rpll_inst/CLKOUT}]
create_generated_clock -name clock_pclk -source [get_ports {CLK_25M}] -master_clock clock_25MHz -divide_by 7 -multiply_by 20 -duty_cycle 50 [get_pins {lcd_pclk_pll/clkdiv_inst/CLKOUT}]
//create_generated_clock -name clock_eth0rx -source [get_ports {CLK_25M}] -master_clock clock_25MHz -divide_by 1 -multiply_by 5 -duty_cycle 50 -phase 45 [get_pins {rx_eth0_rpll/rpll_inst/CLKOUTP}]
create_generated_clock -name clock_gpu -source [get_ports {CLK_25M}] -master_clock clock_25MHz -divide_by 1 -multiply_by 5 -duty_cycle 50 -phase 45 [get_pins {sdram_rpll1/rpll_inst/CLKOUTP}]
create_generated_clock -name clock_sdram -source [get_ports {CLK_25M}] -master_clock clock_25MHz -divide_by 1 -multiply_by 5 -duty_cycle 50 [get_pins {sdram_rpll1/rpll_inst/CLKOUT}]
